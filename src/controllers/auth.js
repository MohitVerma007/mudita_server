...
exports.getMenteeById = async (req, res) => {
  ...
  try {
    const query = `
      SELECT users.user_id, users.name, users.email, users.gender, users.mobile, users.profile_img, users.visibility, mentees.dob, mentees.fcm_token ,mentees.occupation, users.address, mentees.fcm_token, mentees.current_score
      FROM users
...
exports.getMentorById = async (req, res) => {
  ...
  try {
    const query = `
      SELECT users.user_id, users.name, users.email, users.gender, users.mobile, users.profile_img, users.visibility, users.address, mentors.experience, mentors.degree, mentors.medical_lic_num,  mentors.pancard_img, mentors.adharcard_front_img, mentors.adharcard_back_img, mentors.doctor_reg_cert_img, mentors.is_approved
      FROM users
...
exports.getAllMentees = async (req, res) => {
  ...
  try {
    ...
    const query = `
      SELECT users.user_id, users.name, users.email, users.gender, users.mobile, users.profile_img, users.visibility, mentees.dob, mentees.occupation, users.address, mentees.fcm_token, mentees.current_score
      FROM users
      INNER JOIN mentees ON users.user_id = mentees.user_id
...
exports.getAllMentors = async (req, res) => {
  ...
  try {
    ...
    const query = `
      SELECT users.user_id, users.name, users.email, users.gender, users.mobile, users.address, users.visibility, mentors.experience, mentors.degree, mentors.medical_lic_num, users.profile_img, mentors.pancard_img, mentors.adharcard_front_img, mentors.adharcard_back_img, mentors.doctor_reg_cert_img, mentors.is_approved
      FROM users
      INNER JOIN mentors ON users.user_id = mentors.user_id
